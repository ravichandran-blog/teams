...
export interface IYoTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface IYoTabRemoveProps {

}

/**
 * Implementation of Yo Tab remove page
 */
export class YoTabRemove  extends TeamsBaseComponent<IYoTabRemoveProps, IYoTabRemoveState> {
